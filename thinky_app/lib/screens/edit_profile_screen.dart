...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    _selectedAvatar = widget.profile.avatar ?? kidAvatars.first;
  ...
  Future<void> _saveProfile() async {
    final updatedProfile = KidProfile(
      id: widget.profile.id,
      name: _nameController.text.trim(),
      age: int.tryParse(_ageController.text.trim()) ?? _age,
      avatar: _selectedAvatar,
    );

    await LocalProfileService.updateProfile(updatedProfile);
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                _CircleAction(
                  icon: Icons.check,
                  onTap: _isValid ? _saveProfile : null,
                ),
              ],
            ),
          ),
